...
assert.equal(runtime.version, 'engineering-pump-edit-fast-lane.v4', 'Pump edit fast lane runtime must expose v4.');
assert.equal(runtime.cacheKey, '20260621-pump-edit-fast-lane4', 'Pump edit fast lane cache key must match index.');
...
assert(manifest.includes('Pump edit fast lane cache key: engineering-pump-edit-fast-lane.js?v=20260621-pump-edit-fast-lane4'), 'Manifest must document Pump edit fast lane cache key.');
