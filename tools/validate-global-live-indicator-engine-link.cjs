...
assert(indexHtml.includes("engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260704-sink-pabs-dedupe1"), "Index must load the global SNK/pump hover-sync runtime.");
