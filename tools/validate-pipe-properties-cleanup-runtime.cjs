...
assert.deepStrictEqual(
  ...
  ['z in (m)', 'z out (m)'],
  'Cleanup runtime must remove segment z columns.'
);
[
  'Pipe Routing',
  'Pipe Rating/Class',
...
assert(
  indexHtml.includes('engineering-pipe-properties-cleanup-runtime.js?v=20260630-pipe-properties-cleanup1'),
...
assert(
  indexHtml.indexOf('engineering-pipe-properties-cleanup-runtime.js?v=20260630-pipe-properties-cleanup1')
    < indexHtml.indexOf('engineering-pipe-moody-chart-audit.js?v=20260630-pipe-moody-audit-clean-unused-pipe-fields1'),
...
if (manifest) {
  ...
  assert(manifest.includes('20260630-pipe-properties-cleanup1'), 'FILE_MANIFEST must mention the cleanup runtime cache key.');
}

console.log('Pipe Properties cleanup runtime validation passed: early load, removed fields, segment z columns, and scroll stability hooks are locked.');
