...
assert.equal(runtime.version, '2026.06-route-trace-audit-v22', 'Route trace audit runtime should expose the locked v22 version.');
...
assert(
  manifest.includes('Route audit cache key: engineering-route-trace-audit.js?v=20260607-snk-boundary-mode-lock4'),
