...
assert(indexHtml.includes('engineering-canvas-context-dock-20260628-canvas-dock-scroll-anchor1.js?v=20260707-clear-keeps-fluid-basis1'), 'index.html must cache-bust canvas context dock browser issues cleanup with a physical filename.');
...
assert(indexHtml.includes("'engineering-pipe-canvas-hydraulic-label-runtime-20260707-pfv-loss-summary-clean1.js?v=20260711-reynolds-darcy-flash-lock1'"), 'Initial canvas visual runtime pack must include PFV hydraulic labels with a physical filename cache-bust.');
assert(indexHtml.includes("'engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260712-route-warning-color-lock1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
