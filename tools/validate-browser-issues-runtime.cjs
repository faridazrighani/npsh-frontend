...
assert(indexHtml.includes("'engineering-route-trace-audit.js?v=20260703-sink-boundary-input2'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
