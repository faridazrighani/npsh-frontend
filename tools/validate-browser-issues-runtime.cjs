...
assert(indexHtml.includes("'engineering-route-trace-audit.js?v=20260704-sink-pabs-dedupe1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
