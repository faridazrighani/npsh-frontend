...
assert(indexHtml.includes("'engineering-route-trace-audit.js?v=20260628-discharge-duty-status1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
