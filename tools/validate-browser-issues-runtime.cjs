...
assert(indexHtml.includes("'engineering-pipe-canvas-hydraulic-label-runtime-20260707-pfv-loss-summary-clean1.js?v=20260707-pfv-loss-summary-clean1'"), 'Initial canvas visual runtime pack must include PFV hydraulic labels with a physical filename cache-bust.');
assert(indexHtml.includes("'engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260707-pump-panel-clean6'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
