...
assert(indexHtml.includes("'engineering-route-trace-audit.js?v=20260702-object-status-clean1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
