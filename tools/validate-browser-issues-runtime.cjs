...
assert(indexHtml.includes("'engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260711-sink-input-stability1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
