...
assert(indexHtml.includes('engineering-canvas-context-dock-20260628-canvas-dock-scroll-anchor1.js?v=20260629-live-evidence1'), 'index.html must cache-bust canvas context dock browser issues cleanup with a physical filename.');
...
assert(indexHtml.includes("'engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260706-status-matrix-lock1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
