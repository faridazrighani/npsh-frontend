...
assert(indexHtml.includes("'engineering-route-trace-audit.js?v=20260701-object-card-stability1'"), 'Initial canvas visual runtime pack must include route trace canvas layout cleanup.');
