...
assert(runtimeSource.includes('engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260712-sink-solver-flash-lock1'), 'Open-file gate must warm the same route runtime cache key loaded by index.html.');
