...
assert(
  indexHtml.includes('engineering-pump-edit-fast-lane.js?v=20260621-pump-edit-fast-lane5')
    && indexHtml.includes('engineering-realtime-calculation-defense.js?v=20260623-global-dependency-logic1')
...
assert(
  indexHtml.indexOf('engineering-pump-edit-fast-lane.js?v=20260621-pump-edit-fast-lane5')
    < indexHtml.indexOf('engineering-realtime-calculation-defense.js?v=20260623-global-dependency-logic1')
    && indexHtml.indexOf('engineering-realtime-calculation-defense.js?v=20260623-global-dependency-logic1')
