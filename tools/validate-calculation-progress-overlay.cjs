...
assert(
  indexHtml.includes('engineering-pump-edit-fast-lane.js?v=20260621-pump-edit-fast-lane5')
    && indexHtml.includes('engineering-realtime-calculation-defense.js?v=20260621-route-only-pump-fields1')
...
assert(
  indexHtml.indexOf('engineering-pump-edit-fast-lane.js?v=20260621-pump-edit-fast-lane5')
    < indexHtml.indexOf('engineering-realtime-calculation-defense.js?v=20260621-route-only-pump-fields1')
    && indexHtml.indexOf('engineering-realtime-calculation-defense.js?v=20260621-route-only-pump-fields1')
