...
assert(
  indexHtml.indexOf(cacheKey) < indexHtml.indexOf("engineering-simulation-load-transaction-manager.js?v=20260712-simulation-load-primary-apply-evidence-lock1"),
