(function registerEngineeringBilingualImprovements(root) {
  ...
  const TRACE_KEY_MAPPINGS = Object.freeze({
    ...
    'valve-inlet-static-pressure': { i18nKey: 'trace.valve.inletStaticPressure', en: 'Inlet Static Pressure', id: 'Tekanan Statik Inlet' },
    ...
    'valve-estimated-outlet-static-pressure': { i18nKey: 'trace.valve.estimatedOutletStaticPressure', en: 'Estimated Outlet Static Pressure', id: 'Estimasi Tekanan Statik Outlet' },
    'valve-outlet-vapor-margin': { i18nKey: 'trace.valve.outletVaporMargin', en: 'Outlet Vapor Margin', id: 'Margin Uap Outlet' },
