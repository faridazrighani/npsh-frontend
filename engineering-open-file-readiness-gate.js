((rootFactory) => {
  ...
  const VERSION = 'engineering-open-file-readiness-gate.v10-route-runtime-lock';
  const CACHE_KEY = '20260712-open-file-route-runtime-lock1';
  ...
  const ROUTE_TRACE_RUNTIME_SRC = 'engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260712-route-warning-color-lock1';
