...
engineering-pipe-canvas-hydraulic-label-runtime.js public-safe compact Pipe/Fitting/Valve canvas label bridge that suppresses the old delta-P-only SVG label and replaces it with live static endpoint pressure, velocity, Total K, Total hL, Minor loss, and Major loss readouts formatted to 5 decimals from current pipe results/calculation trace, with pump-label-sized upright canonical canvas-anchor placement that stays in the same pipe-relative position on desktop and cellular viewports, and synchronous no-flicker refresh after solver/canvas redraws, without changing calculation data
...
Pipe canvas hydraulic label runtime cache key: engineering-pipe-canvas-hydraulic-label-runtime-20260628-pfv-canvas-anchor1.js?v=20260706-pfv-five-decimals1
...
Route audit cache key: engineering-route-trace-audit-20260704-sink-pabs-dedupe1.js?v=20260706-status-matrix-lock1
