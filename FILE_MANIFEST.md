...
tools/validate-analysis-report-live-runtime.cjs Node validation for Analysis Report live-link runtime loading, existing-table cell refresh behavior including bilingual headers and TH metric rows, Simulasi 1 Fluid/Pipe/Pump/SNK metric mapping, Case Status Summary XLSX export byte generation, cache key, npm script, and manifest lock
...
Analysis Report live runtime cache key: engineering-analysis-report-live-runtime.js?v=20260620-analysis-report-xlsx-export1
