...
engineering-pump-performance-canonical-chart.js public-safe operational smart engineering chart renderer that uses solver-owned performanceChartData before legacy chart arrays or pump props, self-heals realtime update hooks, protects vendor curves, previews design-duty anchored pump/system/NPSH curves, opens separate Pump Performance Chart, Manual NPSHr, and Pump Formula Defense task windows from the pump context menu, hides the relocated Manual NPSHr input and Pump Formula Defense button from Pump Object Properties, and schedules one governed visible-chart render so chart numbers refresh from the latest model without repeated repaint bursts
...
Pump performance chart audit cache key: engineering-pump-performance-chart-audit.js?v=20260621-pump-chart-audit23
Pump performance canonical chart cache key: engineering-pump-performance-canonical-chart.js?v=20260621-canonical-chart17
