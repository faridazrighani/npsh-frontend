...
Excel calculation trace runtime cache key: engineering-excel-calculation-trace-runtime.js?v=20260715-excel-water-only-ph-sheets1
...
Simulation load transaction manager cache key: engineering-simulation-load-transaction-manager.js?v=20260715-external-open-export-unlock1
