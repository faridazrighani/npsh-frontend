...
engineering-fluid-basis-phase-chart-runtime.js public-safe Fluid Basis pressure-enthalpy phase chart runtime that injects a one-column P-h chart at the bottom of the Fluid Basis task window, reads temperature from Fluid Basis, reads Vapor Pressure from Fluid Basis as the chart pressure, compares it with Fluid Basis P_sat(T), draws proportional IAPWS/IF97-style saturation dome and temperature curves matching the reference P-h phase-check chart, redraws a stable SVG chart without calling backend calculations, and exposes export markup for the PDF Fluid Basis discussion
...
Fluid Basis phase chart runtime cache key: engineering-fluid-basis-phase-chart-runtime.js?v=20260708-fluid-phase-chart-if97-1
...
Export equation professional runtime cache key: engineering-export-equation-professional-runtime.js?v=20260710-pdf-equation-professional-route-integrity1
...
Simulation load transaction manager cache key: engineering-simulation-load-transaction-manager.js?v=20260712-simulation-load-stale-promise-clean1
